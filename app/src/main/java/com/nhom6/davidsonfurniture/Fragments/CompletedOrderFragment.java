...
public class CompletedOrderFragment extends Fragment {
    ...
    private List<CompletedOrder> initData() {
        ...
        completedOrders.add(new CompletedOrder(R.drawable.img_sofabang_anastasia, "ANASTASIA", "Sofa băng", "Đen", "8,450,000đ", "Số lượng: 1"));
        completedOrders.add(new CompletedOrder(R.drawable.img_guongdeban_coba, "COBA", "Gương để bàn", "Đen", "1,220,000đ", "Số lượng: 1"));
        completedOrders.add(new CompletedOrder(R.drawable.img_kedungdo_ez, "PAMITI", "Kệ đựng đồ", "Trắng", "1,220,000đ", "Số lượng: 1"));
