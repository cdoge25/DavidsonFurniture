...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnContinueOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(OrderActivity.this, PaymentMethodActivity.class);
                startActivity(i);
            }
        });
    ...
    private void goBack() {
        binding.toolbarOrderActivity.getChildAt(0).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
